...
# Set Hostname
sudo hostnamectl set-hostname $STAGE_WORKER_01_FQDN

# Edit the /etc/hosts file to add the local hostname
sudo sed -i "s\127.0.0.1 localhost\127.0.0.1  $STAGE_WORKER_01_FQDN $STAGE_WORKER_01_FQDN_SHORT\g" /etc/hosts
...
$STAGE_MASTER_01_IP      $STAGE_MASTER_01_FQDN $STAGE_MASTER_01_FQDN_SHORT
EOF
